...
export function YouTubeVideoEditModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/60 dark:bg-slate-950/80 backdrop-blur-md animate-in fade-in duration-200 overflow-y-auto">
      <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl w-full max-w-3xl shadow-2xl overflow-hidden my-8 max-h-[90vh] flex flex-col">
        {/* Header */}
        <div className="flex items-center justify-between px-6 py-4 border-b border-slate-200 dark:border-slate-800 bg-slate-50/80 dark:bg-slate-950/50 flex-shrink-0">
          <div className="flex items-center space-x-3">
            <div className="p-2 rounded-xl bg-red-600/10 text-red-500 dark:text-red-400 border border-red-500/20">
          ...
          <button
            ...
            onClick={onClose}
            disabled={isSaving}
            className="text-slate-400 hover:text-slate-700 dark:hover:text-white p-2 rounded-xl hover:bg-slate-100 dark:hover:bg-slate-800 transition disabled:opacity-50"
          >
            <X className="w-5 h-5" />
          </button>
        </div>
        ...
        <div className="p-6 overflow-y-auto space-y-6 flex-1">
          {isLoading ? (
            ...
            <div className="p-4 rounded-xl bg-rose-50 dark:bg-rose-950/40 border border-rose-200 dark:border-rose-800/80 text-rose-800 dark:text-rose-300 text-xs flex items-start space-x-3">
              ...
              <div className="space-y-1">
                ...
                <button
                  ...
                  className="mt-2 px-3 py-1 bg-rose-100 hover:bg-rose-200 dark:bg-rose-900/60 dark:hover:bg-rose-800 text-rose-800 dark:text-rose-200 rounded-lg text-xs font-semibold flex items-center space-x-1"
                >
            ...
            <form id="edit-youtube-video-form" onSubmit={handleSaveChanges} className="space-y-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-12 gap-5 p-4 rounded-xl bg-slate-50 dark:bg-slate-950/60 border border-slate-200 dark:border-slate-800/80">
                ...
                <div className="sm:col-span-5 space-y-2">
                  ...
                  <div className="flex items-center space-x-2 pt-1">
                    ...
                    <button
                      ...
                      className="flex-1 py-1.5 px-3 rounded-lg bg-white dark:bg-slate-800 hover:bg-slate-100 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-200 text-xs font-semibold transition flex items-center justify-center space-x-1 border border-slate-300 dark:border-slate-700 disabled:opacity-50"
                    >
                    ...
                    {newThumbnailUrl && (
                      <button
                        ...
                        className="py-1.5 px-2.5 rounded-lg bg-white dark:bg-slate-800/80 hover:bg-rose-50 dark:hover:bg-rose-950/60 hover:text-rose-600 dark:hover:text-rose-300 hover:border-rose-300 dark:hover:border-rose-800 text-slate-500 dark:text-slate-400 text-xs transition border border-slate-300 dark:border-slate-700"
                  ...
                  {thumbnailValidationError && (
                    <p className="text-[11px] text-rose-500 dark:text-rose-400 font-medium">{thumbnailValidationError}</p>
                  )}
                ...
                <div className="sm:col-span-7 flex flex-col justify-between space-y-3">
                  <div className="space-y-1.5">
                    <span className="text-[10px] uppercase font-bold text-red-500 dark:text-red-400 tracking-wider">
                      Published Video
                    </span>
                    ...
                    <p className="text-xs text-slate-500 dark:text-slate-400">
                      Channel: <strong className="text-slate-800 dark:text-slate-300">{channelTitle || videoData?.channel_title}</strong>
                    </p>
                  </div>
                  ...
                  {videoData?.video_url && (
                    <div className="pt-2 border-t border-slate-200 dark:border-slate-800/80">
                      <a
                        ...
                        target="_blank"
                        rel="noreferrer"
                        className="inline-flex items-center space-x-1.5 text-xs text-red-600 dark:text-red-400 hover:text-red-700 dark:hover:text-red-300 font-semibold"
                      >
              ...
              <div className="space-y-1.5">
                <div className="flex items-center justify-between">
                  ...
                  <span className={`text-[11px] font-mono ${title.length > 100 ? 'text-rose-500 dark:text-rose-400 font-bold' : 'text-slate-400'}`}>
                    {title.length}/100
                  </span>
                </div>
                <input
                  ...
                  className="w-full bg-white dark:bg-slate-950 border border-slate-300 dark:border-slate-800 rounded-xl px-3.5 py-2.5 text-xs text-slate-900 dark:text-white placeholder-slate-400 dark:placeholder-slate-500 focus:outline-none focus:border-red-500 focus:ring-1 focus:ring-red-500 transition"
                  required
                />
              </div>
              ...
              <div className="space-y-1.5">
                <div className="flex items-center justify-between">
                  ...
                  <span className={`text-[11px] font-mono ${description.length > 5000 ? 'text-rose-500 dark:text-rose-400 font-bold' : 'text-slate-400'}`}>
                ...
                <textarea
                  ...
                  className="w-full bg-white dark:bg-slate-950 border border-slate-300 dark:border-slate-800 rounded-xl px-3.5 py-2.5 text-xs text-slate-900 dark:text-white placeholder-slate-400 dark:placeholder-slate-500 focus:outline-none focus:border-red-500 focus:ring-1 focus:ring-red-500 transition resize-y"
                />
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div className="space-y-1.5">
                  ...
                  <select
                    ...
                    className="w-full bg-white dark:bg-slate-950 border border-slate-300 dark:border-slate-800 rounded-xl px-3 py-2 text-xs text-slate-900 dark:text-white focus:outline-none focus:border-red-500 transition"
                  >
                ...
                {/* Privacy Visibility */}
                <div className="space-y-1.5">
                  <label className="text-xs font-bold text-slate-700 dark:text-slate-200">Visibility</label>
                    ...
                    <button
                      ...
                      className={`p-2 rounded-xl text-xs font-semibold flex items-center justify-center space-x-1.5 border transition ${
                        privacyStatus === 'public'
                          ? 'bg-red-50 dark:bg-red-600/20 text-red-600 dark:text-red-300 border-red-300 dark:border-red-500/50 font-bold'
                          : 'bg-white dark:bg-slate-950 border-slate-300 dark:border-slate-800 text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white'
                      }`}
                    >
                    ...
                    <button
                      ...
                      className={`p-2 rounded-xl text-xs font-semibold flex items-center justify-center space-x-1.5 border transition ${
                        privacyStatus === 'unlisted'
                          ? 'bg-amber-50 dark:bg-amber-600/20 text-amber-700 dark:text-amber-300 border-amber-300 dark:border-amber-500/50 font-bold'
                          : 'bg-white dark:bg-slate-950 border-slate-300 dark:border-slate-800 text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white'
                      }`}
                    >
                    ...
                    <button
                      ...
                      className={`p-2 rounded-xl text-xs font-semibold flex items-center justify-center space-x-1.5 border transition ${
                        privacyStatus === 'private'
                          ? 'bg-indigo-50 dark:bg-indigo-600/20 text-indigo-700 dark:text-indigo-300 border-indigo-300 dark:border-indigo-500/50 font-bold'
                          : 'bg-white dark:bg-slate-950 border-slate-300 dark:border-slate-800 text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white'
                      }`}
                    >
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-[11px] text-slate-500 dark:text-slate-400 font-mono">{tags.length}/30 tags</span>
                </div>

                {/* Tag Pills */}
                <div className="flex flex-wrap gap-1.5 min-h-[36px] p-2 rounded-xl bg-white dark:bg-slate-950 border border-slate-300 dark:border-slate-800">
                  {tags.map((tag) => (
                    <span
                      key={tag}
                      className="inline-flex items-center space-x-1 px-2.5 py-1 rounded-lg bg-slate-100 dark:bg-slate-800 text-slate-800 dark:text-slate-200 text-xs font-medium border border-slate-200 dark:border-slate-700"
                    >
                      <span>#{tag}</span>
                      <button
                        type="button"
                  ...
                  <div className="inline-flex items-center space-x-1 flex-1 min-w-[120px]">
                    <input
                      ...
                      className="bg-transparent text-xs text-slate-900 dark:text-white placeholder-slate-400 dark:placeholder-slate-600 focus:outline-none w-full px-1"
                    />
                  </div>
                </div>
              </div>
                ...
                <div className="space-y-2">
                  <label className="flex items-center space-x-2.5 text-xs text-slate-700 dark:text-slate-300 cursor-pointer">
                    <input
                      ...
                      className="text-red-600 focus:ring-red-500 bg-white dark:bg-slate-900 border-slate-300 dark:border-slate-700"
                    />
        ...
        {/* Modal Footer */}
        <div className="flex items-center justify-between px-6 py-4 border-t border-slate-200 dark:border-slate-800 bg-slate-50/80 dark:bg-slate-950/50 flex-shrink-0">
          <button
            type="button"
            onClick={onClose}
            disabled={isSaving}
            className="px-4 py-2 rounded-xl bg-slate-100 hover:bg-slate-200 dark:bg-slate-800 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-300 text-xs font-semibold transition border border-slate-300 dark:border-transparent disabled:opacity-50"
          >
            Cancel
          </button>
