...
export default function AutomationEmptyState({ onCreateClick }: AutomationEmptyStateProps) {
  return (
    <div className="bg-white dark:bg-slate-900/60 border border-slate-200 dark:border-slate-800/80 rounded-3xl p-8 md:p-12 text-center max-w-4xl mx-auto shadow-sm dark:shadow-xl relative overflow-hidden backdrop-blur-sm">
      {/* Decorative background glow */}
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-96 h-96 bg-indigo-500/5 dark:bg-indigo-500/10 rounded-full blur-3xl pointer-events-none" />
      ...
      <div className="relative z-10 max-w-2xl mx-auto space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-3 text-left pt-2">
          <div className="p-4 rounded-2xl bg-slate-50 dark:bg-slate-950/60 border border-slate-200 dark:border-slate-800/80 space-y-1.5">
            ...
            <h4 className="text-xs font-bold text-slate-900 dark:text-slate-200">Keyword Triggers</h4>
          ...
          <div className="p-4 rounded-2xl bg-slate-50 dark:bg-slate-950/60 border border-slate-200 dark:border-slate-800/80 space-y-1.5">
            ...
            <h4 className="text-xs font-bold text-slate-900 dark:text-slate-200">Public Replies</h4>
            <p className="text-[11px] text-slate-600 dark:text-slate-400 leading-relaxed">
          ...
          <div className="p-4 rounded-2xl bg-slate-50 dark:bg-slate-950/60 border border-slate-200 dark:border-slate-800/80 space-y-1.5">
            ...
            <h4 className="text-xs font-bold text-slate-900 dark:text-slate-200">Private DMs</h4>
            <p className="text-[11px] text-slate-600 dark:text-slate-400 leading-relaxed">
