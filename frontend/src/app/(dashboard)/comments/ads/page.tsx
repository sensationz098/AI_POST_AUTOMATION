    ...
    <div className="p-4 md:p-6 max-w-7xl mx-auto space-y-6 text-slate-900 dark:text-slate-100 font-sans">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-3 bg-white dark:bg-slate-900/70 p-3 rounded-2xl border border-slate-200 dark:border-slate-800/90 shadow-sm">
          <div className="relative flex-1">
            ...
            <input
              ...
              className="w-full bg-white dark:bg-slate-950 border border-slate-300 dark:border-slate-800 focus:border-purple-500 text-xs rounded-xl pl-8 pr-3 py-2 text-slate-900 dark:text-slate-100 placeholder-slate-400 dark:placeholder-slate-500 outline-none transition"
            />
          </div>
            ...
            <div className="flex items-center space-x-2 border-r border-slate-200 dark:border-slate-800/80 pr-3">
              ...
              <button
                ...
                className={`px-3 py-1.5 rounded-lg text-xs font-semibold transition ${
                  adStatusFilter === 'all'
                    ? 'bg-purple-50 text-purple-700 border border-purple-200 shadow-sm dark:bg-purple-950 dark:text-purple-200 dark:border-purple-700/80'
      ...
      <div className="space-y-4 pt-2">
        <div className="flex items-center justify-between text-xs text-slate-500 dark:text-slate-400 font-medium px-1 pb-1 border-b border-slate-200 dark:border-slate-800/60">
          <span className="flex items-center space-x-2 text-purple-600 dark:text-purple-300 font-bold">
          ...
          <span className="text-[11px] text-slate-500 dark:text-slate-500 font-mono">Meta Campaign Ad Content</span>
        </div>
